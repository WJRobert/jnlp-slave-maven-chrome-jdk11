...
RUN 
  yum --disablerepo=rhel-fast-datapath --disablerepo=rhel-server-extras --disablerepo=rhel-server --disablerepo=rhel-server-optional --disablerepo=rhel-server-ose --disablerepo=rhel-server-rhscl -y --setopt=tsflags=nodocs update && \
