...
RUN curl https://copr.fedorainfracloud.org/coprs/alsadi/dumb-init/repo/epel-7/alsadi-dumb-init-epel-7.repo -o /etc/yum.repos.d/alsadi-dumb-init-epel-7.repo && \ 
  ...
  yum $DISABLES --disablerepo=rhel-fast-datapath --disablerepo=rhel-fast-datapath-beta -y install ./google-chrome-stable_current_x86_64.rpm 
...
#  yum $DISABLES --disablerepo=rhel-fast-datapath --disablerepo=rhel-fast-datapath-beta -y install java-11-openjdk-devel
